...
export default function Index() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="mb-1" style={{ marginTop: "400PX" }}>
          <h4
      ...
      <SectionWrapper className="bg-[#EFEFEF] pt-24 pb-24">
        <Agendas />
      </SectionWrapper>
      ...
      <div className="py-24 text-gray-700 relative text-center font-sans" >
        © 2022 by <span className="font-semibold">Akhil</span>
      </div>
